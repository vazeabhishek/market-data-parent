                ...
                <div id="collapse${key?index}" class="collapse hide" data-parent="#accordion">
                    <div class="card-body">
                        <table class="table table-light">
                            ...
                            <#list value as data>
                                <tr>
                                    <td><a href="/equity-daily/history/${data.symbol}">${data.symbol}</a></td>
                                    <td>${data.expiry_dt}</td>
                                    <td>${data.buyers_won_count}</td>
                                    <td>${data.sellers_won_count}</td>
                                    <td>${data.higher_high_count}</td>
                                    <td>${data.lower_low_count}</td>
                                </tr>
                            </#list>
                        </table>
                    </div>
